...
export class Init1689268697488 implements MigrationInterface {
    name = 'Init1689268697488'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "orden_items" ("producto_id" integer NOT NULL, "orden_id" integer NOT NULL, "cantidad" integer NOT NULL, CONSTRAINT "PK_e829bab7139a42421ba5ee309b0" PRIMARY KEY ("producto_id", "orden_id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "productos" ("id" SERIAL NOT NULL, "createAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updateAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "nombre" character varying NOT NULL, "precio" numeric NOT NULL, "stock" numeric NOT NULL, "categoria_id" integer NOT NULL, CONSTRAINT "PK_04f604609a0949a7f3b43400766" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "orden_items" ADD CONSTRAINT "FK_0338075bbe6b4213477f145d661" FOREIGN KEY ("orden_id") REFERENCES "ordenes"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
